...
- **Segurança**: HTTPS; projeto MIT e auto-hospedável, sem evidência pública suficiente sobre a instância.
- **Veredito**: reprovado. Remover a instância pública ou auto-hospedar sob governança adequada.
- **Fonte**: <https://github.com/gnuns/AllOrigins>.
